Code for the surrogate model in the paper [The deep latent space particle filter for real-time data assimilation with uncertainty quantification](https://www.nature.com/articles/s41598-024-69901-7).
...
For the data assimilation code associated with the same paper, see this [repository](https://github.com/nmucke/data-assimilation).
